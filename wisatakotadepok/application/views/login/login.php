<link rel="stylesheet" href="<?php echo base_url('dist/style/login.css')?>" media="screen">
    <section class="u-clearfix u-section-1" id="sec-0134">
            ...
            <div class="u-layout-row">
              ...
              <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-valign-middle u-container-layout-2">
                  ...
                  <a href="<?php echo base_url('index.php/register')?>" data-page-id="2102029892" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-create-account u-none u-text-grey-40 u-text-hover-palette-4-base u-btn-2">Don't have an account?</a>
                </div>
              </div>
            </div>
          </div>
